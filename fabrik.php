<?php  include "header.html" ?>
	...
	<div class="row">
		<div id="presentation" class="col-xs-12 col-sm-12 col-md-10 col-md-offset-1 col-lg-10 col col-lg-offset-1">
			<div class="row">
				<h2 class="letterpress">Présentation</h2>
			<article class="will col-xs-12 col col-sm-12  col-md-10 col-md-offset-1 col-lg-10 col col-lg-offset-1">
	...
	<div class="row">
			...
			<div id="plan" class="col-xs-12 col-sm-12 col-md-12  col-lg-12 col ">
