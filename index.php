	...
	<div id="conteneur" class="col-xs-12 col-md-9"> 		<!--Conteneur detier la Une, Menu press et social -->
		<div id="laUne" class="">
			...
			<div class="les-articles">
				...
				<div class="row">
					<img id="articleimg2" class="articleimg2 col-xs-10 col-xs-offset-1 col-md-3 col-md-offset-0" src="img/une3.png" width="500px" alt="">
					<img id="articleimg3" class="articleimg3 col-xs-10 col-xs-offset-1 col-md-3 col-md-offset-0" src="img/une3.png" width="500px" alt="">
					<img id="articleimg4" class="articleimg4 col-xs-10 col-xs-offset-1 col-md-3 col-md-offset-0" src="img/une3.png" width="500px" alt=""> 
					<img id="articleimg5" class="articleimg5 col-xs-10 col-xs-offset-1 col-md-3 col-md-offset-0" src="img/une3.png" width="500px" alt="">
				</div>  
			</div>	
		</div>
	</div>
...
<div id="containerDeux col-md-12 ">
	<div id="oldPresse" class="col-xs-12 col-md-10"> 
